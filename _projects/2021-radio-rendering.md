...
<img src="{{"/assets/images/TW_iso_view.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/TW_top_ZI.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/TW_side_ZI.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/TW_low_ZI.png" | relative_url }}" width ="50%">


5.2.1.2

<img src="{{"/assets/images/materials_plot.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/materials_options.png" | relative_url }}" width ="50%">
...
<img src="{{"/assets/images/BCs_ss.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/BC_force_ss.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/BC_displ_ss.png" | relative_url }}" width ="50%">
...
<img src="{{"/assets/images/zoomedOut_normal_strain.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/zoomedIn_normal_strain.png" | relative_url }}" width ="50%">
...
<img src="{{"/assets/images/ZO_max_principle.png" | relative_url }}" width ="50%">

<img src="{{"/assets/images/ZI_max_principle.png" | relative_url }}" width ="50%">

5.2.1.6

Normal Stress Contour
<img src="{{"/assets/images/normal_stress.png" | relative_url }}" width ="50%">

Deflection in X-Dimension
<img src="{{"/assets/images/directional_deflection.png" | relative_url }}" width ="50%">

Normal Strain at Gauge
<img src="{{"/assets/images/zoomedIn_normal_strain.png" | relative_url }}" width ="50%">

Equivalent Strain at Gauge
<img src="{{"/assets/images/equivalent_strain_at_sg.png" | relative_url }}" width ="50%">

Equivalent Stress
<img src="{{"/assets/images/Z_VM_stress.png" | relative_url }}" width ="50%">
...
<img src="{{"/assets/images/straingauge.png" | relative_url }}" width ="50%">
